...
G4PTrueMuonium1S * G4PTrueMuonium1S::theInstance = nullptr;

G4PTrueMuonium1S * G4PTrueMuonium1S::Definition()
{
  if ( theInstance ) {
    return theInstance;
  }
  const G4String name = "ptm-1s";
  ...
  const G4double width = pow(alpha,5.)*muMass/2.;      // in MeV
  ...
  if ( !anInstance ) {
    anInstance = new G4ParticleDefinition(
        ...
        /* lepton number ............ */ 0,
        /* baryon number ............ */ 0,
        /* PDG encoding ............. */ 898, // https://pdg.lbl.gov/2019/reviews/rpp2019-rev-monte-carlo-numbering.pdf
        /* stable ................... */ false, // allow decay
        /* lifetime.................. */ 0, 
        /* decay table .............. */ NULL,
        /* shortlived ............... */ false,
        /* subType .................. */ "ptm-1s",
        /* anti particle encoding ... */ 898
          );
  ...
  theInstance = reinterpret_cast<G4PTrueMuonium1S*>(anInstance);
  return theInstance;
}
