...
G4OTrueMuonium2S * G4OTrueMuonium2S::theInstance = nullptr;

G4OTrueMuonium2S * G4OTrueMuonium2S::Definition()
{
  if ( theInstance ) {
    return theInstance;
  }
  const G4String name = "otm-2s";
  ...
  const G4double width = pow(alpha,5.)*muMass/(6.*pow(n,3.));      // in MeV
  ...
  if ( !anInstance ) {
    anInstance = new G4ParticleDefinition(
        ...
        /* lepton number ............ */ 0,
        /* baryon number ............ */ 0,
        /* PDG encoding ............. */ 999, // https://pdg.lbl.gov/2019/reviews/rpp2019-rev-monte-carlo-numbering.pdf
        /* stable ................... */ false, // allow decay
        /* lifetime.................. */ 0, 
        /* decay table .............. */ NULL,
        /* shortlived ............... */ false,
        /* subType .................. */ "otm-2s",
        /* anti particle encoding ... */ 999
          );
  ...
  theInstance = reinterpret_cast<G4OTrueMuonium2S*>(anInstance);
  return theInstance;
}
